using CalculatorLibrary.TheNigerianNerd;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (!endApp)
        {
            ...
            Console.Write("Press 'l' to list previous games , or press 'n' and Enter to close the app, or press any other key and Enter to continue: ");

            // If the user presses 'l', list previous operations.
